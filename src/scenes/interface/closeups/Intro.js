...
export default class Intro extends Closeup {
    ...
    _create() {
        ...
        title.setStyle({align: 'center', fixedWidth: 800, fontFamily: 'Burbank Small', fontSize: '48px', fontStyle: 'bold', 'shadow.color': '#ffffffff', 'shadow.fill': true})
        ...
        content.setStyle({align: 'center', fixedWidth: 800, fontFamily: 'Burbank Small', fontSize: '28px', 'shadow.color': '#ffffffff', 'shadow.fill': true})
        ...
        okay.text = 'Okay'
        okay.setStyle({align: 'center', fixedWidth: 800, fontFamily: 'Burbank Small', fontSize: '48px', fontStyle: 'bold', 'shadow.color': '#ffffffff', 'shadow.fill': true})
