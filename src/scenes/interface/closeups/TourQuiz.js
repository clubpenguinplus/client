...
export default class TourQuiz extends BaseScene {
    ...
    _create() {
        ...
        button_q1_rightButton.callback = () => {this.onQ1(); this.correctAnswer();};
        ...
        button_q2_rightButton.callback = () => {this.nextQuestion(); this.correctAnswer();};
        ...
        button_q3_rightButton.callback = () => {this.nextQuestion(); this.correctAnswer();};
        ...
        button_q4_rightButton.callback = () => {this.onQ4(); this.correctAnswer();};
        ...
        button_q5_rightButton.callback = () => {this.onQ5(); this.correctAnswer();};
        ...
        button_q6_rightButton.callback = () => {this.onQ6(); this.correctAnswer();};
        ...
        button_q7_rightButton.callback = () => {this.onQ7(); this.correctAnswer();};
        ...
        button_q8_rightButton.callback = () => {this.onQ8(); this.correctAnswer();};
        ...
        button_q9_rightButton.callback = () => {this.onQ9(); this.correctAnswer();};
        ...
        button_q10_rightButton.callback = () => {this.onQ10(); this.correctAnswer();};
        ...
        button_winButton.callback = () => {this.onWin(); this.scene.stop()};
