...
export default class IglooMap extends BaseContainer {
    constructor(scene, x, y) {
        ...
        // igloo_bg
        const igloo_bg = scene.add.image(-11, -44, 'map-for-igloo', 'igloo/bg')
        this.add(igloo_bg)
        ...
        // igloo_note
        const igloo_note = scene.add.image(-485, -268, 'map-for-igloo', 'igloo/note')
        this.add(igloo_note)
        ...
        // spinner
        const spinner = scene.add.image(-19, -55, 'map-for-igloo', 'igloo/spinner')
        ...
        // igloo_card
        const igloo_card = scene.add.image(197, 318, 'map-for-igloo', 'igloo/card')
        panel.add(igloo_card)

        // igloo_tape
        const igloo_tape = scene.add.image(5, 0, 'map-for-igloo', 'igloo/tape')
        igloo_tape.setOrigin(0.5017421602787456, 0.5)
        panel.add(igloo_tape)

        // igloo_item_large
        const igloo_item_large = scene.add.image(183, 72, 'map-for-igloo', 'igloo/item_large')
        panel.add(igloo_item_large)

        // igloo_icon_player
        const igloo_icon_player = scene.add.image(18, 72, 'map-for-igloo', 'igloo/icon_player')
