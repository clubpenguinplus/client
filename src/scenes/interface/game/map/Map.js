...
export default class Map extends BaseContainer {
    constructor(scene, x, y) {
        ...
        const hydrohopperupgradesSimpleButton = new SimpleButton(hydrohopperupgrades)
        hydrohopperupgradesSimpleButton.callback = () => this.onRoomClick(800)
        ...
        const sledraceupgradesSimpleButton = new SimpleButton(sledraceupgrades)
        sledraceupgradesSimpleButton.callback = () => this.onRoomClick(230)
        ...
        const map_puffles_wildSimpleButton = new SimpleButton(map_puffles_wild)
        map_puffles_wildSimpleButton.callback = () => this.onRoomClick(436)
