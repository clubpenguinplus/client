...
export default class Unlock extends BaseScene {
    ...
    _create() {
        ...
        // code
        const code = this.add.image(0, 10.539267711483149, 'unlock', 'codeinput')
        codeOption.add(code)

        // nextbutton
        const nextbutton = this.add.image(0, 74.53926771148315, 'unlock', 'codebutton')
        ...
        // codeInput
        const codeInput = this.add.text(780, 715, '', {})
        codeInput.scaleY = 1.6
        codeInput.setOrigin(0.5, 0.5)
        codeInput.alpha = 0.8
        ...
        // topchestt
        const topchestt = this.add.sprite(790, 311, 'unlock', 'topchestt')
        topchestt.scaleX = 0.9
        topchestt.scaleY = 0.9
        topchestt.visible = false
        ...
        // topchest
        const topchest = this.add.sprite(832, 258, 'unlock', 'topchest')
        topchest.scaleX = 0.9
        topchest.scaleY = 0.9
        topchest.visible = false

        // bottomchest
        const bottomchest = this.add.sprite(789, 697, 'unlock', 'bottomchest')
        bottomchest.scaleX = 0.9
        bottomchest.scaleY = 0.9
        bottomchest.visible = false
        ...
        codeInputInputText.charlimit = 24
        codeInputInputText.entercallback = () => {
            this.onCodeInput()
        }
        ...
        this.topchestt = topchestt
        this.oneItem = oneItem
        this.coins = coins
        this.coinholder = coinholder
        this.coinstext = coinstext
        this.item = item
        this.topchest = topchest
        this.bottomchest = bottomchest
