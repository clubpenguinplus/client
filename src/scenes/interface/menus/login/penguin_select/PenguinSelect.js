...
import {Animation, NineSlice, SimpleButton, LocalisedString} from '@components/components'
...
export default class PenguinSelect extends BaseScene {
    ...
    create() {
        ...
        let savedPenguins = Object.values(this.airtower.savedPenguins).slice(0, 6)
