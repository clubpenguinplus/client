...
export default class SavePrompt extends BaseContainer {
    constructor(scene, x, y) {
        ...
        text_1LocalisedString.id = 'savePass'

        // text_2 (components)
        const text_2LocalisedString = new LocalisedString(text_2)
        text_2LocalisedString.id = 'dontSavePass'

        // text_3 (components)
        const text_3LocalisedString = new LocalisedString(text_3)
        text_3LocalisedString.id = 'learnMore'
