...
import {SimpleButton, LocalisedString} from '@components/components'
...
export default class Checks extends BaseContainer {
    constructor(scene, x, y) {
        ...
        text_2.setStyle({align: 'right', color: '#000000ff', fontFamily: 'cpBurbankSmall', fontSize: '30px'})
        ...
        text_1.setStyle({align: 'right', color: '#000000ff', fontFamily: 'cpBurbankSmall', fontSize: '30px'})
        ...
        text_2LocalisedString.id = 'rememberPass'

        // text_1 (components)
        const text_1LocalisedString = new LocalisedString(text_1)
        text_1LocalisedString.id = 'remember'
