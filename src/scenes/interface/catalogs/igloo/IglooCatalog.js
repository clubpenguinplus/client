...
export default class IglooCatalog extends Book {
    ...
    preload() {
        ...
        this.load.pack('igloocatalog-pack', 'client/media/interface/catalogs/igloo/igloocatalog-pack.json')
    ...
    _create() {
        ...
        const small_buy0001_png_1_2_2_2_2_1_1_1_1_1 = this.add.image(573, 368, 'Sep2005', 'small-buy0001.webp')
        page3.add(small_buy0001_png_1_2_2_2_2_1_1_1_1_1)

        // small_buy0001_png_1_2_2_2_2_1_1_1_2
        const small_buy0001_png_1_2_2_2_2_1_1_1_2 = this.add.image(565, 544, 'Sep2005', 'small-buy0001.webp')
        page3.add(small_buy0001_png_1_2_2_2_2_1_1_1_2)

        // small_buy0001_png_1_2_2_2_2_1_1_2
        const small_buy0001_png_1_2_2_2_2_1_1_2 = this.add.image(911, 694, 'Sep2005', 'small-buy0001.webp')
        ...
        const small_buy0001_png_1_2_2_2_2_1_2 = this.add.image(572, 712, 'Sep2005', 'small-buy0001.webp')
        page3.add(small_buy0001_png_1_2_2_2_2_1_2)

        // small_buy0001_png_1_2_2_2_2_2
        const small_buy0001_png_1_2_2_2_2_2 = this.add.image(562, 204, 'Sep2005', 'small-buy0001.webp')
        ...
        const small_buy0001_png_1_2_2_2_2 = this.add.image(585, 478, 'Sep2005', 'small-buy0001.webp')
        page2.add(small_buy0001_png_1_2_2_2_2)

        // small_buy0001_png_1_2_2_2_2_1
        const small_buy0001_png_1_2_2_2_2_1 = this.add.image(587, 685, 'Sep2005', 'small-buy0001.webp')
        page2.add(small_buy0001_png_1_2_2_2_2_1)

        // small_buy0001_png_1_2_2_2_2_1_1
        const small_buy0001_png_1_2_2_2_2_1_1 = this.add.image(1147, 705, 'Sep2005', 'small-buy0001.webp')
        page2.add(small_buy0001_png_1_2_2_2_2_1_1)

        // small_buy0001_png_1_2_2_2_2_1_1_1
        const small_buy0001_png_1_2_2_2_2_1_1_1 = this.add.image(1147, 464, 'Sep2005', 'small-buy0001.webp')
        page2.add(small_buy0001_png_1_2_2_2_2_1_1_1)

        // small_buy0001_png_1_2_2_2_2_1_1_1_1
        const small_buy0001_png_1_2_2_2_2_1_1_1_1 = this.add.image(1145, 244, 'Sep2005', 'small-buy0001.webp')
        ...
        // next_page0001_png
        const next_page0001_png = this.add.image(984, 691, 'Sep2005', 'next-page0001.webp')
        ...
        small_buy0001_png_1_2_2_2_2_1_2Button.spriteName = 'small-buy0001.webp'
        ...
        small_buy0001_png_1_2_2_2_2_2Button.spriteName = 'small-buy0001.webp'
        ...
        next_page0001_pngButton.spriteName = 'next-page0001.webp'
    ...
    showPrompt(id, type, callback) {
        ...
        let text = `Would you like to buy ${name}\n for ${cost} coins? You currently have ${this.shell.client.coins} coins.`
