...
export default class LocationPage extends Page {
    constructor(scene, x, y) {
        ...
        // location
        const location = scene.add.image(760, 480, '2')
        this.add(location)
        ...
        // closebtn
        const closebtn = scene.add.image(1488, 26, 'constant', 'closebtn')
        this.add(closebtn)
        ...
        description.text = 'Soak up the sun on your beach property!'
        description.setStyle({align: 'center', color: '#000000ff', fixedWidth: 450, fontFamily: 'cpBurbankSmall', fontSize: '25px'})
