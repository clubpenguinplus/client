...
export default class CostumeCatalog extends Book {
    ...
    preload() {
        ...
        this.load.pack('costume-pack', 'client/media/interface/catalogs/costume/costume-pack.json')
    }
    ...
    _create() {
        ...
        // buy_director
        const buy_director = this.add.image(360, 271, 'Sep2005', 'small-buy0001.webp')
        ...
        // buy_moose
        const buy_moose = this.add.image(880, 221, 'Sep2005', 'small-buy0001.webp')
        page3.add(buy_moose)
        ...
        buy_directorButton.spriteName = 'small-buy0001.webp'
        ...
        buy_mooseButton.spriteName = 'small-buy0001.webp'
