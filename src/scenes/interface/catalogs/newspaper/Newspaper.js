...
export default class Newspaper extends News {
    ...
    /** @returns {void} */
    preload() {
        this.load.pack('news-pack', 'client/media/interface/catalogs/newspaper/news-pack.json')
    }
    ...
    _create() {
        ...
        // pAPER_png_1_1_1_1_1
        const pAPER_png_1_1_1_1_1 = this.add.image(760, 480, 'newspaper', 'PAPER.webp')
        page6.add(pAPER_png_1_1_1_1_1)

        // content6_png
        const content6_png = this.add.image(760, 436, 'newspaper', 'content6.webp')
        ...
        // pAPER_png_1_1_1_1
        const pAPER_png_1_1_1_1 = this.add.image(760, 480, 'newspaper', 'PAPER.webp')
        page5.add(pAPER_png_1_1_1_1)

        // content5_png
        const content5_png = this.add.image(760, 495, 'newspaper', 'content5.webp')
        ...
        // pAPER_png_1_1_1
        const pAPER_png_1_1_1 = this.add.image(760, 480, 'newspaper', 'PAPER.webp')
        page4.add(pAPER_png_1_1_1)

        // content4_png
        const content4_png = this.add.image(760, 500, 'newspaper', 'content4.webp')
        ...
        // pAPER_png_1_1
        const pAPER_png_1_1 = this.add.image(760, 480, 'newspaper', 'PAPER.webp')
        page3.add(pAPER_png_1_1)

        // content3_png
        const content3_png = this.add.image(761, 456, 'newspaper', 'content3.webp')
        ...
        // pAPER_png_1
        const pAPER_png_1 = this.add.image(760, 480, 'newspaper', 'PAPER.webp')
        page2.add(pAPER_png_1)

        // content2_png
        const content2_png = this.add.image(761, 426, 'newspaper', 'content2.webp')
        ...
        // pAPER_png
        const pAPER_png = this.add.image(760, 480, 'newspaper', 'PAPER.webp')
        page1.add(pAPER_png)

        // content1_png
        const content1_png = this.add.image(745, 458, 'newspaper', 'content1.webp')
