...
export default class Forest extends RoomScene {
    ...
    _create() {
        ...
        rectangle_1Zone.hoverCallback = () => {this.boulder.play('forest-boulder'); this.shell.musicController.addSfx('forest-boulderopen')};
        rectangle_1Zone.hoverOutCallback = () => {this.boulder.playReverse('forest-boulder'); this.shell.musicController.addSfx('forest-boulderclose')};
