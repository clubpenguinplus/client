...
export default class Dock extends RoomScene {
    ...
    _create() {
        ...
        // grave2
        const grave2 = this.add.image(763.6562590093293, 613.0830946874963, "dock", "grave2");
        grave2.setOrigin(0.5024054136770407, 0.6386282341069264);
        ...
        // pile
        const pile = this.add.image(615.3286171918406, 652.3169778418023, "dock", "pile");
        pile.setOrigin(0.40482145284611193, 0.6794968506510578);
        ...
        // grave3
        const grave3 = this.add.image(478.90584663845095, 582.3285479893564, "dock", "grave3");
        grave3.setOrigin(0.315069644749493, 0.6065922189615489);

        // grave4
        const grave4 = this.add.image(377.4062746516921, 633.043445299478, "dock", "grave4");
        grave4.setOrigin(0.24829359547276003, 0.6594202484690844);
        ...
        // grave6
        const grave6 = this.add.image(586.5000453927935, 543.201901995433, "dock", "grave6");
        grave6.setOrigin(0.3858552832943517, 0.5658353216740764);
