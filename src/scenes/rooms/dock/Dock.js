...
export default class Dock extends RoomScene {
    ...
    _create() {
        ...
        rectangle_1SimpleButton.hoverCallback = () => { this.smallcatalog.__Animation.play() };
        rectangle_1SimpleButton.hoverOutCallback = () => { this.smallcatalog.setFrame("catalog0001") };
        ...
        rectangleSimpleButton.hoverCallback = () => { this.ring.__Animation.play(); this.shell.musicController.addSfx('dock-tubes') };
