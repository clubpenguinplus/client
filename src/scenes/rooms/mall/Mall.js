...
export default class Mall extends RoomScene {
    ...
    _create() {
        ...
        // chair_pointing_br_1 (components)
        const chair_pointing_br_1SimpleButton = new SimpleButton(chair_pointing_br_1);
        chair_pointing_br_1SimpleButton.callback;

        // costumes (components)
        const costumesButton = new Button(costumes);
        costumesButton.spriteName = "costumes";
        costumesButton.hoverCallback = () => {this.shell.musicController.addSfx('mall-chestopen'); this.glow.visible=true};
        costumesButton.hoverOutCallback = () => {this.shell.musicController.addSfx('mall-chestclose'); this.glow.visible=false};
