...
export default class Book extends RoomScene {
    ...
    create() {
        ...
        this.leftseatzone = new Phaser.Geom.Ellipse(this.seatzone.x, this.seatzone.y, this.seatzone.width, this.seatzone.height);
        this.rightseatzone = new Phaser.Geom.Ellipse(this.seatzone_1.x, this.seatzone_1.y, this.seatzone_1.width, this.seatzone_1.height);

        // if (this.leftseatzone.contains(this.client.penguin.x, this.client.penguin.y)) {
        //     this.newspaper.play('printingpress');
        //     this.newssquiggle.play('newssquiggle');
        //     this.shell.musicController.addSfx('book-printingpress');
        // } return
    }
