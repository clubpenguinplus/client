...
export default class Shop extends RoomScene {
    ...
    _create() {
        ...
        spinnerSimpleButton.hoverCallback = () => {this.onSpinnerOver(); this.shell.musicController.addSfx('shop-spinner')};
        spinnerSimpleButton.hoverOutCallback = () => {this.onSpinnerOut(); this.shell.musicController.stopLoopingSfx('shop-spinner')};
