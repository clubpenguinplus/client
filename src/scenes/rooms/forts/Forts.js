...
export default class Forts extends RoomScene {
    ...
    _create() {
        ...
        // container_1
        const container_1 = this.add.container(754.0933626159435, 689.2939427134747);

        // pumpkman
        const pumpkman = this.add.image(5.906612152878438, -209.29393915558842, "forts", "pumpkman");
        container_1.add(pumpkman);

        // fountain
        const fountain = this.add.sprite(-52.09338784712156, 18.70606084441158, "forts", "fountain0001");
