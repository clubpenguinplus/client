...
export default class Beacon extends RoomScene {
    ...
    _create() {
        ...
        jetpackZoneSimpleButton.hoverCallback = () => {this.onJetpackOver(); this.shell.musicController.addSfx('beacon-jetpackopen')};
        jetpackZoneSimpleButton.hoverOutCallback = () => {this.onJetpackOut(); this.shell.musicController.addSfx('beacon-jetpackclose')};
