...
export default class Skate extends RoomScene {
    ...
    _create() {
        ...
        bg.setOrigin(0, 0)
        bg.tintTopLeft = 11782109
        bg.tintTopRight = 11782109
        bg.tintBottomLeft = 11782109
        bg.tintBottomRight = 11782109

        // bench
        const bench = this.add.image(1204, 207, 'skate', 'bench')
        bench.tintTopLeft = 11782109
        bench.tintTopRight = 11782109
        bench.tintBottomLeft = 11782109
        bench.tintBottomRight = 11782109
        ...
        railing2.tintTopLeft = 11782109
        railing2.tintTopRight = 11782109
        railing2.tintBottomLeft = 11782109
        railing2.tintBottomRight = 11782109
        ...
        railing3.tintTopLeft = 11782109
        railing3.tintTopRight = 11782109
        railing3.tintBottomLeft = 11782109
        railing3.tintBottomRight = 11782109

        // pillar
        const pillar = this.add.image(5, 429, 'skate', 'pillar')
        pillar.tintTopLeft = 11782109
        pillar.tintTopRight = 11782109
        pillar.tintBottomLeft = 11782109
        pillar.tintBottomRight = 11782109

        // pillar2
        const pillar2 = this.add.image(196, 209, 'skate', 'pillar2')
        pillar2.tintTopLeft = 11782109
        pillar2.tintTopRight = 11782109
        pillar2.tintBottomLeft = 11782109
        pillar2.tintBottomRight = 11782109
        ...
        puffle.tintTopLeft = 11782109
        puffle.tintTopRight = 11782109
        puffle.tintBottomLeft = 11782109
        puffle.tintBottomRight = 11782109

        // puffle_1
        const puffle_1 = this.add.image(180, 149, 'skate', 'puffle')
        puffle_1.scaleX = 0.5
        puffle_1.scaleY = 0.5
        puffle_1.tintTopLeft = 11782109
        puffle_1.tintTopRight = 11782109
        puffle_1.tintBottomLeft = 11782109
        puffle_1.tintBottomRight = 11782109

        // skate
        const skate = this.add.image(324, 178, 'skate', 'skate')
        skate.tintTopLeft = 11782109
        skate.tintTopRight = 11782109
        skate.tintBottomLeft = 11782109
        skate.tintBottomRight = 11782109
        ...
        fg2.tintTopLeft = 11782109
        fg2.tintTopRight = 11782109
        fg2.tintBottomLeft = 11782109
        fg2.tintBottomRight = 11782109

        // fg1
        const fg1 = this.add.image(770, 826, 'skate', 'fg1')
        fg1.tintTopLeft = 11782109
        fg1.tintTopRight = 11782109
        fg1.tintBottomLeft = 11782109
        fg1.tintBottomRight = 11782109
        ...
        bar.tintTopLeft = 11782109
        bar.tintTopRight = 11782109
        bar.tintBottomLeft = 11782109
        bar.tintBottomRight = 11782109
        ...
        railing1.tintTopLeft = 11782109
        railing1.tintTopRight = 11782109
        railing1.tintBottomLeft = 11782109
        railing1.tintBottomRight = 11782109
