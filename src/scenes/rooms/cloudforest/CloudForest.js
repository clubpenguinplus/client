...
export default class CloudForest extends RoomScene {
    ...
    create() {
        super.create()
        this.puffle1.play('puffle1');
        this.puffle2.play('puffle2');
        this.puffle3.play('puffle3');
        this.puffle4.play('puffle4');
        this.puffle5.play('puffle5');
        this.puffle6.play('puffle6');
        this.puffle7.play('puffle7');
        this.puffle8.play('puffle1');
    }
