...
export default class Pet extends RoomScene {
    ...
    _create() {
        ...
        // parkrailleft
        const parkrailleft = this.add.image(1312, 479, "pet", "parkrailleft");
        ...
        // lists
        const sort = [fgtubes, adopttext_en, ball, adoptbookbase, art, pinkbowl, petfg, bed, post, postright, foodbowl, bluefrontpost, skateboard, petcat_en, adoptbutton, bluebackpost, surf, parkrailright, parkrailleft];
