...
export default class Coffee extends RoomScene {
    ...
    _create() {
        ...
        // bookroomdoor
        const bookroomdoor = this.add.sprite(1294.772927498817, 588.9487961054027, 'coffee', 'bookroomdoor')
        bookroomdoor.setOrigin(0.45688283877951824, 1.0017969623208385)
