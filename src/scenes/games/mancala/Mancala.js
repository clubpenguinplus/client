...
export default class Mancala extends BaseContainer {
    constructor(scene, x, y) {
        ...
        end_hitbox0004SimpleButton.hoverCallback = () => this.onHitboxOver(0)
        end_hitbox0004SimpleButton.hoverOutCallback = () => this.onHitboxOut(0)
        end_hitbox0004SimpleButton.callback = () => this.onHitboxDown(0)

        // cup_hitbox0004 (components)
        const cup_hitbox0004SimpleButton = new SimpleButton(cup_hitbox0004)
        cup_hitbox0004SimpleButton.hoverCallback = () => this.onHitboxOver(1)
        cup_hitbox0004SimpleButton.hoverOutCallback = () => this.onHitboxOut(1)
        cup_hitbox0004SimpleButton.callback = () => this.onHitboxDown(1)

        // cup_hitbox (components)
        const cup_hitboxSimpleButton = new SimpleButton(cup_hitbox)
        cup_hitboxSimpleButton.hoverCallback = () => this.onHitboxOver(2)
        cup_hitboxSimpleButton.hoverOutCallback = () => this.onHitboxOut(2)
        cup_hitboxSimpleButton.callback = () => this.onHitboxDown(2)

        // cup_hitbox_1 (components)
        const cup_hitbox_1SimpleButton = new SimpleButton(cup_hitbox_1)
        cup_hitbox_1SimpleButton.hoverCallback = () => this.onHitboxOver(4)
        cup_hitbox_1SimpleButton.hoverOutCallback = () => this.onHitboxOut(4)
        cup_hitbox_1SimpleButton.callback = () => this.onHitboxDown(4)

        // cup_hitbox_2 (components)
        const cup_hitbox_2SimpleButton = new SimpleButton(cup_hitbox_2)
        cup_hitbox_2SimpleButton.hoverCallback = () => this.onHitboxOver(3)
        cup_hitbox_2SimpleButton.hoverOutCallback = () => this.onHitboxOut(3)
        cup_hitbox_2SimpleButton.callback = () => this.onHitboxDown(3)

        // cup_hitbox_3 (components)
        const cup_hitbox_3SimpleButton = new SimpleButton(cup_hitbox_3)
        cup_hitbox_3SimpleButton.hoverCallback = () => this.onHitboxOver(6)
        cup_hitbox_3SimpleButton.hoverOutCallback = () => this.onHitboxOut(6)
        cup_hitbox_3SimpleButton.callback = () => this.onHitboxDown(6)

        // cup_hitbox_4 (components)
        const cup_hitbox_4SimpleButton = new SimpleButton(cup_hitbox_4)
        cup_hitbox_4SimpleButton.hoverCallback = () => this.onHitboxOver(5)
        cup_hitbox_4SimpleButton.hoverOutCallback = () => this.onHitboxOut(5)
        cup_hitbox_4SimpleButton.callback = () => this.onHitboxDown(5)
        ...
        cup_hitbox_5SimpleButton.callback = () => this.onHitboxDown(8)
        ...
        cup_hitbox_6SimpleButton.callback = () => this.onHitboxDown(12)
        ...
        cup_hitbox_7SimpleButton.callback = () => this.onHitboxDown(13)
        ...
        cup_hitbox_8SimpleButton.callback = () => this.onHitboxDown(10)
        ...
        cup_hitbox_9SimpleButton.callback = () => this.onHitboxDown(11)
        ...
        cup_hitbox_10SimpleButton.callback = () => this.onHitboxDown(9)

        // end_hitbox (components)
        const end_hitboxSimpleButton = new SimpleButton(end_hitbox)
        end_hitboxSimpleButton.hoverCallback = () => this.onHitboxOver(7)
        end_hitboxSimpleButton.hoverOutCallback = () => this.onHitboxOut(7)
        end_hitboxSimpleButton.callback = () => this.onHitboxDown(7)
    ...
    onHitboxDown(hitbox) {
        let hitBoxes = [0, 1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13]
        console.log('Hitbox is ', hitbox)
        console.log('Stones in Hitbox', this.map[hitbox].stones)
        if (this.map[hitbox].stones != 0) {
            console.log('There were non-zero stones in the hitbox')
            let stonesToPlace = this.map[hitbox].stones / this.map[hitbox].stones
            for (let i = 0; i < this.map[hitbox].stones; i++) {
                let nextHitbox = hitBoxes[hitbox + i]
                console.log('Next Hitbox: ', nextHitbox)
                this.map[nextHitbox].stones += stonesToPlace
            }
            this.map[hitbox].stones = 0
        } else {
            return
        }
    }
