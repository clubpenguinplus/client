...
export const preload = {
    key: 'mancala-pack',
    url: 'client/media/games/mancala/mancala-pack.json',
    loadString: 'mancala'
}
...
export default class Mancala extends BaseContainer {
    ...
    setupMap() {
        ...
        for (let i = 0; i < this.map.length; i++) {
            ...
            for (let j = 0; j < count; j++) {
                ...
                currentColor = currentColor >= this.maxStoneColor ? 1 : currentColor + 1
            }
        }
    ...
    moveStones(args) {
        ...
        hole.stones
            .slice(0)
            .reverse()
            .map((stone) => this.bringToTop(stone))
    ...
    dropStone(i, stone, hole, delay = this.dropDelay) {
        this.delayedCall(i * delay, () => {
            ...
            if (this.isMancala(hole)) {
                this.shell.musicController.addSfx('mancala-drop', false, 'mp3', 0.5)
            } else {
                this.shell.musicController.addSfx('mancala-drop', false, 'mp3', 0.2)
            }
