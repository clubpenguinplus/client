...
export default class SenseiMatch extends BaseContainer {
    constructor(scene, x, y) {
        ...
        message.setStyle({align: 'center', fixedWidth: 460, fontFamily: 'cpBurbankSmall', fontSize: '32px'})
        this.add(message)
        ...
        time.text = '10'
        time.setStyle({align: 'center', fixedWidth: 60, fontFamily: 'cpBurbankSmall', fontSize: '32px', fontStyle: 'bold'})
        this.add(time)
